...
Knowing the soil type of your land can be fairly useful as soil types conveys 
...
can be **correlated to some international system** e.g. WRB or KST [@krasilnikov2009handbook]. 
...
potentially of variable accuracy and should be only use to fill-in gaps in training data.
...
also observations of the shifting sand, permanent ice and bare-rocks [@tsendbazar2021towards].
...
The shows that the two most probable soil type at this location are `Haplic.Chernozems` 
